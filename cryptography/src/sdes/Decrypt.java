...
public class Decrypt {
	public static void main(String[] args) throws UnsupportedEncodingException {
		...
		System.out.println(sdes.K1);
		sdes.getKey10(new Scanner("0111111101"));
		System.out.println(sdes.byteArrayToString(sdes.decrypt(bytes)));
		byte[] bytes2 = new byte[] {122, -24, -63, 122};
		sdes.getKey10(new Scanner("1010101010"));
		System.out.println(sdes.byteArrayToString(sdes.decrypt(bytes2)));
	}
}
